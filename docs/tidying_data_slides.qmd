...
transport[1:4, ]
## The weight & height columns only
...
> `|>` (or `%>%`) places the **output of the a function** as the **first argument** of the next function!
...
::: {.fragment}
<br>Both of these are identical in their results
:::
...
- The packages `dplyr`, `ggplot1` and `readr` are used in most workflows
