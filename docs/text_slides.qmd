...
- Won't explore in much detail today
...
- Including when numbers are included
...
- Patterns can be extended by adding a `+` symbol <br>$\implies$ Match one or more values
    + Will return the first run of one or more *lowercase letters*
...
- Additional strategies for manipulating levels
