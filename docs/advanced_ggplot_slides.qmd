...
# Using the Complete Tidyverse {background-color="#3c3c44" background-image=https://www.tidyverse.org/images/hex-tidyverse.png background-size="30%" background-opacity="0.2"}
...
# Visualising Data {background-color="#3c3c44" background-image=https://ggplot2.tidyverse.org/logo.png background-size="40%" background-opacity="0.4"}
...
- Similarly for the points: `colour = "grey30"`
    ...
    + Note that for 21-25 colour is outline, fill is the internal colour
...
# Modifying Data Prior To Plotting {background-color="#3c3c44" background-image=https://carpentries-incubator.github.io/open-science-with-r/img/05-tidyr.png background-size="40%" background-opacity="0.4"}
...
# Themes {background-color="#3c3c44" background-image=https://ggplot2.tidyverse.org/logo.png background-size="40%" background-opacity="0.4"}
