...
# R Markdown {background-color="#3c3c44" background-image=https://raw.githubusercontent.com/rstudio/rmarkdown/main/man/figures/logo.png background-size="30%" background-opacity="0.4"}
...
- Italic text is set by surrounding text with a single asterisk (`*`) or underscore (`_`)
...
`# Introduction to R, Sept 19th 2023`
...
`**All material**` can be found at \[the couse homepage\]\(http://blackochrelabs.au/230919_R4Bio/\)
